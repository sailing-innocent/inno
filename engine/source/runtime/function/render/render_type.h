...
INNO_NAMESPACE_BEGIN
    enum class INNO_IMAGE_TYPE : uint8_t
    {
        INNO_IMAGE_TYPE_UNKNOWM = 0,
        INNO_IMAGE_TYPE_2D
    };
    ...
    public:
        ...
        INNO_IMAGE_TYPE   m_type { INNO_IMAGE_TYPE::INNO_IMAGE_TYPE_UNKNOWM};
...
template<>
struct std::hash<inno::MeshSourceDesc>
{
    size_t operator()(const inno::MeshSourceDesc& rhs) const noexcept { return rhs.getHashValue(); }
};
template<>
struct std::hash<inno::MaterialSourceDesc>
{
    size_t operator()(const inno::MaterialSourceDesc& rhs) const noexcept { return rhs.getHashValue(); }
};
