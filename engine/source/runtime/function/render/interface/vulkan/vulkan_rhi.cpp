...
INNO_NAMESPACE_BEGIN
    ...
    VulkanRHI::~VulkanRHI()
    {
        LOG_INFO("Vulkan RHI Constructed");
    }

    void VulkanRHI::initialize(RHIInitInfo init_info)
    {
        LOG_INFO("Vulkan RHI Init");
        ...
        // https://gcc.gnu.org/onlinedocs/cpp/Common-Predefined-Macros.html
#if defined(__linux__)
        char const* vk_layer_path = INNO_XSTR(INNO_VK_LAYER_PATH);
        setenv("VK_LAYER_PATH", vk_layer_path, 1);
#elif defined(__MACH__)
        // https://developer.apple.com/library/archive/documentation/Porting/Conceptual/PortingUnix/compiling/compiling.html
        char const* vk_layer_path    = INNO_XSTR(INNO_VK_LAYER_PATH);
        char const* vk_icd_filenames = INNO_XSTR(INNO_VK_ICD_FILENAMES);
        setenv("VK_LAYER_PATH", vk_layer_path, 1);
...
#error Unknown Compiler
    ...
    void VulkanRHI::createInstance()
    {
        ...
        appInfo.pApplicationName   = "inno_renderer";
        appInfo.applicationVersion = VK_MAKE_VERSION(1, 0, 0);
        appInfo.pEngineName        = "inno";
    ...
    bool VulkanRHI::createCommandPool(const RHICommandPoolCreateInfo* pCreateInfo, RHICommandPool* &pCommandPool)
    {
        ...
        {
            // ERROR("vkCreateCommandPool is failed!");
            return false;
        }
    }
    ...
    RHISampler* VulkanRHI::getOrCreateDefaultSampler(RHIDefaultSamplerType type)
    {
        switch (type)
        {
        case inno::Default_Sampler_Linear:
        ...
        case inno::Default_Sampler_Nearest:
    ...
    inno::QueueFamilyIndices VulkanRHI::findQueueFamilies(VkPhysicalDevice physicalm_device) // for device and surface
    {
    ...
    inno::SwapChainSupportDetails VulkanRHI::querySwapChainSupport(VkPhysicalDevice physicalm_device)
    {
